...
>
> This playground moved to [Vault-Playground-on-Kubernetes](https://github.com/adfinis/Vault-Playground-on-Kubernetes). The Vault specific instructions in [USAGE.md](./USAGE.md) are still applicable to some degree.
