...
resource "vault_ldap_auth_backend" "ldap" {
  ...
  insecure_tls = true
  userdn       = "cn=users,cn=accounts,dc=${loca.container_domain_dc1},dc=${loca.container_domain_dc2}"
  userattr     = "uid"
  groupdn      = "cn=groups,cn=accounts,dc=${loca.container_domain_dc1},dc=${loca.container_domain_dc2}"
